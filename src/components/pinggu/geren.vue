<template>
	<div class="chufen">
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">个人风险点</a>
				</div>
		...
		<div class="main">
			<div class="header">
				<a href="javascript:;" class="fr" @click="routerTo">添加</a>
				<h2>个人风险点</h2>
			</div>
			<div class="p_risk">
				<div class="content">
							...
							<table id="table-content">
								...
								<tbody>
									<tr>
										...
										<td>未审批</td>
										<td><a href="javascript:;" class="btn-primary bin" @click="routerTo2">查看</a></td>
									</tr>
									<tr>
										<td>2</td>
										<td>辛庄派出所</td>
...
export default {
	...
	methods: {
		...
		routerTo2() {
			this.$router.push({ path: 'chakan', query: { ids: 1 } });
		}
	}
};
</script>

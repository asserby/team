<template>
	<div class="chufen">
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">监督列表</a>
				</div>
		...
		<div class="main">
			<div class="header"><h2>监督列表</h2></div>
			<div class="supervise">
				<div class="content">
					<div class="ibox">
						<div class="ibox-content">
							<div class="head">
								<div>
									<label for="">问题单位：</label>
									<select class="console">
										<option value="">请选择问题单位</option>
										<option value="">党委成员</option>
										<option value="">工会</option>
										<option value="">党委成员</option>
										<option value="">工会</option>
										<option value="">党委成员</option>
									</select>
								...
								<div>
									...
									<input type="date" class="console" />
									<span>到</span>
									<input type="date" class="console" />
								</div>
								<div><a href="javascript:;" class="btn-primary">搜索</a></div>
							</div>
							<table id="table-content">
								...
								<tbody>
									<tr>
										<td>1</td>
										<td>辛庄派出所</td>
										<td>2017-09-13 09:37:42</td>
										<td>已签收</td>
										<td>
											<a href="javascript:;" class="btn-primary bin" @click="routerkan">查看</a>
...
export default {
	...
	methods: {
		routerkan() {
			this.$router.push({ path: 'chakan', query: { ids: 3 } });
		}
	}
};
</script>

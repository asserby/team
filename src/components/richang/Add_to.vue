<template>
	<div class="chufen">
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">单位风险点</a>
				</div>
		...
		<div class="add_to">
			<div class="content">
				<div class="ibox">
					<div class="ibox-title"><h5>添加公告</h5></div>
					<div class="ibox-content ">
						<div class="form">
							<div>
								<label for="c">公告名称：</label>
								<input type="text" class="console" />
							</div>
							<div>
								<label for="b">公告内容：</label>
								<quill-editor
									v-model="content"
									ref="myQuillEditor"
							...
							<div>
								<label for="c">显示时间：</label>
								<input type="datetime-local" class="console" />
							</div>
							<div>
								<label for=""></label>
								<button>保 存</button>

<template>
	<div class="chufen">
		...
		<div class="my_leave">
			<div class="content">
				<div class="ibox">
					<div class="ibox-title"><h5>我的请假列表</h5></div>
					<div class="ibox-content">
						<table class="table table-striped table-hover">
							<thead style="background: #1c84c6; color: #fff;">
								<tr class="qhl-tabletr">
									<td>序号</td>
									<td>请假人员</td>
									<td>请假类型</td>
									<td>请假事由</td>
							...
							<tbody>
								<tr>
									<td>1</td>
									<td><router-link to="History">管理员</router-link></td>
									<td>事假</td>
									<td>有事</td>
									<td>2017-12-08 00:00</td>
									<td>2017-12-15 00:00</td>
									<td>7天</td>
									<td>已撤销</td>
								</tr>
								<tr>

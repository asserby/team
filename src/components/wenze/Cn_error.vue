<template>
	<div class="zuzhi">
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">日常纠错</a>
				</div>
		...
		<div class="cn_error">
			<div class="content">
				<div class="ibox">
					<div class="ibox-title"><router-link to="Juicuo_form1" class="btn-primary">添加</router-link></div>
					<div class="ibox-content">
						<div class="head">
							<div>
								<label for="">推送单位：</label>
								<input class="console" />
							</div>
							<div>
						...
						<table>
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>问题问题问题问题问题问题问题问题问题问题问题问题问题问题问题问题</td>
									<td>党委</td>
									<td>2017-06-27</td>
									<td>正在处理</td>
									<td><a href="javascript:;" class="btn-primary">签收</a></td>
								</tr>
							</tbody>
						</table>
						<div class="tongji">

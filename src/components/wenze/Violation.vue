<template>
	<div class="zuzhi">
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">违纪办理</a>
				</div>
		...
		<div class="violation">
			<div class="content">
				<div class="ibox">
					<div class="ibox-title"><a href="javascript:;" class="btn-primary">违纪办理</a></div>
					<div class="ibox-content">
						<form action="">
							<ul>
								<li>
									<label for="">案件编号：</label>
									<input type="text" />
								</li>
								<li>
									<label for="">案件名称：</label>
									<input type="text" />
								</li>
								<li>
								...
								<li>
									<label for="">涉及人员：</label>
									<input type="text" />
								</li>
								<li>
									<label for="">涉及单位：</label>
									<input type="text" />
								</li>
								<li>
									<a href="javascript:;" class="btn-primary">搜索</a>
									<a href="javascript:;" class="btn-primary bin">重置</a>
								</li>
							</ul>
						</form>
						<table>
...
.ibox-content form ul {
	display: flex;
	flex-wrap: wrap;
	border: 1px solid #ebebeb;
}
.ibox-content form ul li {
	width: 25%;
	height: 46px;
	box-sizing: border-box;
	padding: 8px;
...
.ibox-content form ul label {
	font-weight: bold;
	color: #717476;
	font-size: 14px;
}
.ibox-content form ul input {
	width: 120px;
	height: 34px;

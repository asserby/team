		...
		<div class="content-tabs">
			<div class="page-tabs clearfix">
				<div class="page-tabs-content">
					...
					<a href="javascript:;" class="active">修改密码</a>
				</div>
		...
		<div class="modify">
			<div class="form">
				<div>
					...
					<input type="text" class="console" placeholder="18301055385" disabled="disabled" />
				</div>
				<div>
					<label for="c">原密码：</label>
					<input type="text" class="console" placeholder="原密码" />
				</div>
				<div>
					<label for="c">新密码：</label>
					<input type="text" class="console" placeholder="新密码" />
				</div>
				<div>
					<label for="c">确认新密码：</label>
					<input type="text" class="console" placeholder="新密码" />
				</div>
				<div>
					<label for=""></label>
